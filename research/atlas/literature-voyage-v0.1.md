...
| World Health Organization and International Telecommunication Union, **“Safe Listening Devices and Systems”** (2019), [standard](https://www.who.int/publications/i/item/9789241515276) — **E** | Treat exposure as sound level over duration; file-level loudness and peak checks are not at-ear dosimetry or proof of hearing safety. |
...
| Porcino et al., **“SPIRIT Extension and Elaboration for N-of-1 Trials: SPENT 2019 Checklist”** (2020), [doi:10.1136/bmj.m122](https://doi.org/10.1136/bmj.m122) — **E/guidance** | Extends protocol-reporting guidance for prospective N-of-1 trials, including design, sequence, allocation, carryover, analysis, adverse events, and protocol changes. | Use as the primary checklist for freezing Antidote's prospective repeated-session protocol. Following a checklist does not confer ethics approval, causal identification, or clinical status. |
| Vohra et al., **“CONSORT Extension for Reporting N-of-1 Trials: CENT 2015 Statement”** (2015), [doi:10.1136/bmj.h1738](https://doi.org/10.1136/bmj.h1738) — **E/guidance** | Provides prospective reporting structure for individual and series-of-N-of-1 trials. | Preserve for the later Results/reporting gate so assignments, periods, withdrawals, harms, and complete denominators do not disappear. It does not validate Antidote's measures. |
| Eldridge et al., **“CONSORT 2010 Statement: Extension to Randomised Pilot and Feasibility Trials”** (2016), [doi:10.1136/bmj.i5239](https://doi.org/10.1136/bmj.i5239) — **E/guidance** | Centers feasibility objectives, prespecified progression decisions, and transparent reporting rather than premature effectiveness conclusions. | Use its feasibility-versus-efficacy distinction and progression logic without representing this one-person design as a definitive randomized trial. |
| Shiffman, Stone, and Hufford, **“Ecological Momentary Assessment”** (2008), [doi:10.1146/annurev.clinpsy.3.022806.091415](https://doi.org/10.1146/annurev.clinpsy.3.022806.091415) — **A/method** | Reviews repeated, near-real-time assessment in everyday settings, including recall, reactivity, compliance, missingness, and contextual interpretation. | Supports session-proximal and later-window self-report while requiring burden and missingness to remain visible. It does not make brief custom items validated clinical outcomes. |
| Betella and Verschure, **“The Affective Slider”** (2016), [doi:10.1371/journal.pone.0148037](https://doi.org/10.1371/journal.pone.0148037) — **B/method** | Evaluates a digital pleasure/valence and arousal self-report interface against the Self-Assessment Manikin for picture ratings. | Supports low-burden valence/arousal capture in a digital interface. Antidote must not generalize the paper's picture-rating validation to every music, moment, or custom appraisal item. |
