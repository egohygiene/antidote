...
| ANT-SRC-004 | Source synthesis | Musical response is multiply determined; perceived expression, felt emotion, meaning, welcome or unwelcome experience, and harm require distinct interpretation rather than inference from an acoustic or physiological label. | Juslin and Västfjäll; Zentner et al.; Kaelen et al.; Rowe et al.; Silverman et al. source records. | Related Work; Methods; Discussion; Limitations. | Promoted measurement and setting synthesis. It establishes neither a universal response taxonomy nor a generated-audio benefit or treatment mechanism. |
| ANT-SRC-005 | Source synthesis | Behavioral findings for music or auditory-beat conditions do not establish a reliable brainwave-entrainment mechanism; the reviewed EEG literature remains inconsistent and methodologically heterogeneous. | Mallik and Russo; Ingendoh et al. source records. | Related Work; Methods; Limitations. | Promoted mechanism boundary. Do not infer a universal frequency prescription, efficacy, or impossibility of an individual effect. |
| ANT-SRC-006 | Source synthesis | N-of-1, pilot-feasibility, ecological momentary assessment, compact affect-report, and digital study-platform sources support prospective specification, near-event repeated measurement, complete denominators, burden accounting, and explicit progression rules as methodological precedents. | Porcino et al.; Eldridge et al.; Shiffman et al.; Betella and Verschure; Konigorski et al. source records. | Methods; Results; Limitations. | Promoted protocol synthesis. These sources do not validate Antidote's conditions, custom items, software, collection setting, safety, or efficacy. |
| ANT-SRC-007 | Source synthesis | Music-induced harm, generative-audio ethics, health-AI governance, and safe-listening sources require review of emotional and physical harm, autonomy, consent, accountability, inclusiveness, model and output rights, bias, misuse, and sound exposure before human use. | Silverman et al.; Barnett; WHO health-AI guidance; WHO--ITU safe-listening source records. | Limitations; Ethics statement; Availability. | Promoted risk-review synthesis. The sources define review categories and constraints; they do not evaluate Antidote, establish incidence, clear rights, confer ethics approval, or prove that a proposed control provides privacy, accessibility, hearing safety, clinical safety, or benefit. |
...
| ANT-OBS-002 | Observation | The repository implements a reproducible publication workspace and an executable synthetic session through a rule-guided local core and deterministic mock worker; real-model audio, full provenance export, and a formal study remain incomplete. | Checked-in source, tests, `SYSTEM.md`, and `ARCHITECTURE.md` at the reviewed revision. | System Design; Results as technical status only; Discussion; Availability. | Repository observation. Re-check against the source revision before publication; synthetic execution is not participant evidence. |
| ANT-OBS-003 | Observation | Results reporting contract `ANT-REPORT-RESULTS-001` version 1.0.0 registers no qualifying T0, T1, or H1 source package and deterministically renders unavailable or blocked states rather than result values. | Versioned reporting contract, absent reserved result-package paths, generator, and issue #41 validation. | Results; Appendix; Availability. | Repository observation about this exact contract revision. It is not a claim that no event occurred outside the protocol, and unavailable is not zero. |
| ANT-OBS-004 | Observation | Results reporting contract `ANT-REPORT-RESULTS-001` version 1.1.0 defines corrected analysis coverage, privacy-safe public H1 envelope boundaries, and blocked or unavailable states, and registers no qualifying T0, T1, or H1 source package. | Amended reporting contract, absent reserved public-package paths, final protocol 1.1.0 byte lock, and issue #82 validation. | Results; Appendix; Availability. | Current repository observation at the validated v1.1 contract revision. It is not evidence that no event occurred outside the protocol; absent, declined, unsure, and zero remain non-interchangeable. |
...
| ANT-CLM-002 | Claim | Passive observations, when used, remain optional and uncertain tailoring variables that a person can inspect and correct; they are not objective emotion or need. | De Angel et al.; D'Amelio et al.; JITAI record; architecture map; AI constitution. | System Design; Methods; Discussion; Limitations. | Accepted design constraint; study behavior and measurement validity remain unverified. |
...
| ANT-CLM-004 | Claim | The v0 authority model requires explicit human approval for context, plan acceptance, generation, playback, retention, export, and any personal-model update, with stop and correction preserved. | `AI_CONSTITUTION.md`, `PERSONAL_MODEL.md`, contracts, and checked-in mock implementation evidence. | System Design; Methods; Discussion; Limitations; Availability. | Accepted design rule; distinguish enforced mock paths from proposed real-model and study behavior. |
...
| ANT-CLM-006 | Claim | Protocol `ANT-PROT-FEAS-001` prospectively freezes separate design-traceability, synthetic technical, real-model technical, and within-person record-feasibility stages, together with conditions, measures, field-level missingness, progression, safety, and deviation rules. | Frozen protocol version 1.1.0, its content lock and deviation log, preserved version 1.0.0 predecessor, schema mappings, issue #40 review, and issue #82 pre-collection correction. | Methods; Results; Discussion; Appendix; Limitations. | Accepted protocol-artifact claim while the version 1.1.0 lock and deterministic checks remain valid. Collection authority remains false; the amendment occurred before qualifying collection and does not imply execution, participants, ethics approval, safety, efficacy, or observed outcomes. |
| ANT-CLM-007 | Claim | Results reporting contract `ANT-REPORT-RESULTS-001` version 1.1.0 binds every future result slot to a named source record, protocol version, analysis pointer, evidence class, and promotion review, gives progression and previously uncovered analyses explicit slots, and requires H1 repository evidence to use reconciled privacy-reviewed aggregate public envelopes while preserving non-positive and unavailable states. | Versioned reporting contracts 1.0.0 and 1.1.0, regenerated empty-state tables, manuscript Results section, issue #41 provenance, and issue #82 correction tests. | Results; Discussion; Appendix; Availability. | Accepted reporting-architecture claim while the protocol hash and generated projections remain valid. The public-envelope commitment is an integrity aid, not proof of anonymity, consent, authenticity, truth, completeness, efficacy, or safety; the contract creates no evidence and authorizes no collection. |
