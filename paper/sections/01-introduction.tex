...
Table~\ref{tab:evidence-claim-classification} defines the evidence vocabulary
used across the complete manuscript and the boundary each class must cross
before it can support a stronger statement.

\AntidoteTable{evidence-claim-classification}
...
\begin{enumerate}
  ...
  \item it \emph{requires} a local-first authority model in which context use,
    ...
    behavior; and
  \item it \emph{specifies prospectively} an evidence-disciplined
