...
\AntidoteDeclareVisualText
  ...
  {Capability-level comparison of prior systems and the bounded Antidote inspectability chain.}
  {A comparator table marks prior precedent for closed-loop control, current-to-target journeys, generation, physiology, interpretability, personalization, and provenance.}
  {Rows represent evaluated systems and columns represent capability families from the governed comparator matrix. Marks show documented support, partial support, or absence within the bounded review. A final Antidote design row is labeled proposed and is not presented as evidence of implementation, novelty, or benefit.}
  {planned}
